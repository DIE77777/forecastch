...
if uploaded_file is not None and run == True:
    ...
    #df=pd.read_excel('C:/Users/diego/Documents/GitHub/forecastch/vetas_ch.xlsx', sheet_name='cargue_r')
    ...
    df_export_wide = df_export.pivot_table(index=['producto', 'COD_CLIENTE', 'COD_PRODUCTO'], columns='ds', values='VENTA NETA (TON)')
